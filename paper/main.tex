...
\title[Diffantom]{Diffantom: a software stack to build digital phantoms of whole-brain diffusion MRI}
...
These compartements will be derived from the macroscopic structure of tissues within the brain,
