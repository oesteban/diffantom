...
The \gls*{hcp} indicates \emph{bedpostx} to reconstruct their data \citep{glasser_minimal_2013}.
Additionally, this software was able to exploit the multi-shell acquisitions of the \gls*{hcp} while
...
This step produces an important smoothing of the maps, while preserving the edges in them.
