...
The simulation process begins with generating a micro-structural model from real data (\autoref{fig:figure1}).
...
These isotropic fraction maps use the \emph{5TT format} established with \emph{MRTrix3} \citep{tournier_mrtrix_2012}
...
This micro-structural model is fed into a simulation block that generates the final \gls*{dmri} dataset
