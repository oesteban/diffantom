...
The final outcome of such applications, called tractography, is fundamental to gain information about
  \gls*{wm} morphology in neurosurgical planning, post-surgery evaluations, and the study of neurological
  diseases such as multiple sclerosis, and Alzheimer's disease \citep{chua_diffusion_2008}.
...
In this work we propose \emph{diffantom}, an \emph{in-silico} dataset to assess tractography pipelines using
  real datasets as source of whole-brain micro-structural information.
...
\begin{itemize}
  \item Comparison of the impact of the different diffusion sampling schemes on the local micro-structure
  model of choice and the subsequent global tractography outcome.
  \item Investigation of the effects of the different artifacts (noise, susceptibility-derived, Eddy-currents,
  etc.) on the final connectivity matrix.
