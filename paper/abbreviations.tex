...
% @Last Modified time: 2015-12-16 16:39:23
...
{
	name={BIDS},
	first={BIDS standard \cite[Brain Imaging Data Structure,][]{gorgolewski_brain_2015}},
...
{
	name={BEDPOSTX},
	first={BEDPOSTX \cite[Bayesian Estimation of Diffusion Parameters Obtained using Sampling Techniques modelling crossing --X-- fibres,][]{jbabdi_modelbased_2012}},
	description={Bayesian Estimation of Diffusion Parameters Obtained using Sampling Techniques modelling crossing --X-- fibres}
}
\newacronym[first={FAST \cite[FMRIB's Automated Segmentation Tool,][]{zhang_segmentation_2001}}]%
{fast}{FAST}{FMRIB's Automated Segmentation Tool}
\newacronym[first={FIRST \cite[FMRIB's Integrated Registration and Segmentation Tool,][]{patenaude_bayesian_2011}}]%
